...
//https://mercadodev-042019.firebaseio.com/anuncios.json?orderBy=%22categoria%22&equalTo=%22esportes-e-lazer%22
...
class Categoria extends Component {
    ...
    loadAnuncios(urlCategoria){
        ...
        //carrega os dados
        const url = `https://mercadodev-042019.firebaseio.com/anuncios.json?orderBy=%22categoria%22&equalTo=%22${urlCategoria}%22`
        axios
            .get(url)
            .then( data => {
